...
\centering
\includegraphics[alt={3D-PRIMME workflow from local grain-ID patches to autoregressive microstructure prediction},width=0.96\textheight]{figures/primme_workflow.png}
