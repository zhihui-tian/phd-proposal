...
\begin{figure}[htbp]
\centering
\includegraphics[alt={3D-PRIMME workflow from local grain-ID patches to autoregressive microstructure prediction},width=0.98\textwidth]{figures/primme_workflow.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[alt={Kinetic, topological, grain-count, and grain-size statistics across three simulation domain sizes},width=0.78\textwidth]{figures/primme_spatial_scaling.png}
...
\section{Aim 1: Establish reliable and generalizable learning from sparse 4D experiments}
...
\section{Aim 2: Validate simulation-trained and experiment-trained surrogates against their respective reference domains}
...
\section{Simulation-physics and surrogate-model foundations}
...
\section{Experimentally grounded learning contribution}
...
\section{Source-aware validation contribution}
...
\section{Physical-science contribution}
