...
\section{4. Grain-Growth Modeling Background}

\subsection{4.1 Stochastic voxel-based simulation}
...
\subsection{4.2 Local surrogate learning}
...
\subsection{4.3 Sparse 4D experimental observations}
...
\section{5. Neighborhood-Dependent Simulation Physics}

\textbf{Research status: COMPLETED PRIOR WORK}

\subsection{5.1 Neighborhood geometry as a label-quality problem}
...
\subsection{5.3 Completed results}
...
\subsection{5.4 Role and claim boundary}
...
\section{6. Simulation-Based Surrogate Learning: 3D-PRIMME}

\textbf{Research status: COMPLETED PRIOR WORK; MANUSCRIPT UNDER REVIEW}

\subsection{6.1 Architecture and simulation supervision}
...
\subsection{6.2 Completed performance}
...
\subsection{6.3 Scientific lesson and limitation}
...
\section{7. Limitations of Simulation Supervision}
...
\section{8. Challenges of Learning from Sparse 4D Experiments}

\subsection{8.1 Structured label uncertainty}
...
\subsection{8.2 Spatial abundance and temporal scarcity}
...
\subsection{8.3 Multilevel validation}
...
\section{9. Preliminary Experimental Work}

\textbf{Research status: ONGOING WORK WITH STABLE PRELIMINARY RESULTS}

\subsection{9.1 Experimental data and curation}
...
\subsection{9.2 Direct experimental training}
...
\subsection{9.3 Stable preliminary results}
...
\subsection{9.4 What the preliminary work establishes}
...
\subsection{10.1 Aim 1: Establish reliable and generalizable learning from sparse 4D experiments}
...
\subsection{10.2 Aim 2: Validate simulation-trained and experiment-trained surrogates against their respective reference domains}
...
\subsection{10.3 Aim 3: Interpret experimentally learned evolution rules and test candidate physical mechanisms}
...
\section{11. Integration Across Aims}
...
\section{12. Expected Contributions}

\subsection{12.1 Simulation-physics contribution}
...
\subsection{12.2 Computational contribution}
...
\subsection{12.3 Experimentally grounded learning contribution}
...
\subsection{12.4 Source-aware validation contribution}
...
\subsection{12.5 Physical-science contribution}
...
\section{13. Risks and Alternative Strategies}

\subsection{13.1 Experimental-data risk}
...
\subsection{13.2 Validation and uncertainty risk}
...
\subsection{13.3 Paired-comparison risk}
...
\subsection{13.4 Interpretation risk}
...
\subsection{13.5 Schedule risk and scope control}
...
\section{15. Expected Dissertation Chapters}
